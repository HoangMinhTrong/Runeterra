                    ...
                    <div className="w-full lg:w-4/12 px-4">
                            ...
                            <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
                                ...
                                <form onSubmit={handleSubmit}>
                                    <div className="relative w-full mb-3">
                                        <label className="block uppercase text-coolGray-600 text-xs font-bold mb-2">
                                            Email
                                        </label>
                                        <input
                                            type="text"
                                    ...
                                    <div className="relative w-full mb-3">
                                        <label className="block uppercase text-coolGray-600 text-xs font-bold mb-2" htmlFor="grid-password">
                                            Password
                                        </label>
                                        <input
                                            type="password"
                                    ...
                                    <button
                                        className="bg-blueGray-800 text-white active:bg-blueGray-600 font-bold uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 w-full ease-linear transition-all duration-150"
                                        type="submit"
                                    >
                                        Sign In
                                    </button>
                        ...
                        <div className="flex flex-wrap mt-6 relative">
                            ...
                            <div className="w-1/2 text-right">
                                <Link to="/auth/register" className="text-coolGray-200">
